...
func ExampleSendFingerprintServerOnline() {
	...
	fmt.Println(strings.Contains(response, `"success":true`))
	// Output: true
}
...
func ExampleSendFingerprintServerOffline() {
	...
	response, err := sendFingerprint("https://asldkfjaklsdjfklasjdfljaslkdjf.com", f)
	if err != nil {
		fmt.Println(err)
	}
	fmt.Println(response)
	// Output: Post https://asldkfjaklsdjfklasjdfljaslkdjf.com: dial tcp: lookup asldkfjaklsdjfklasjdfljaslkdjf.com: getaddrinfow: No such host is known.
}
